...
""" ___ zip_longest ___ """
# — это метод, который позволяет создавать итератор сопоставляющий элементы нескольких
# последовательностей, даже если они имеют разную длину, что полезно, когда требуется обработать данные, учитывая
# разные длины или пропуски в последовательностях.
