...
""" __ NB! __ """ # Для аргументов и возвращаемых значений функций, аннотации типов __указываются__
                  # в сигнатуре функции после имени параметра или после стрелки ( -> ) для возвращаемого значения.
...
""" ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 __ NB! __ После -> нужно указывать то, что стоит в ():  (... str) -> str, 
 тогда worning (желтое предупреждение) о возможной ошибке НЕ будет. 
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ """
...
# # ++++++++++++++++++++++++++++++++++++++++
# from typing import Optional, Union       # Из модуля импортировали функции или...import
...
""" %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%____________   Модуль operator   _____________%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% """
...
# - позволяет получить доступ (по ключу) к определенному элементу или атрибуту объекта и может быть использована в
#   качестве компаратора при сортировке.
...
""" %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%____________   Модуль bisect   _____________%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% """

""" __________ Бинарный поиск __________ """    # - Video 48, 1:13:00
# — эффективный алгоритм поиска элемента в _ТОЛЬКО_ отсортированном списке. Что означает, что можно отсеять
#   половину данных, чтобы корректно искать в этих данных.

""" __________ Модуль bisect __________ """     # - Video 48, 1:13:05
# — предоставляет функции для выполнения бинарного поиска.
""" __ NB! __ """   # Модуль используется не часто, но полезен для понимания работы с некоторыми данными,
                    # в некотором роде начало логики алгоритмов.
...
# from bisect import bisect_left, bisect_right
# # +++++++++++++++++++++++++++++++++++++++++++++++
# # Границы интервалов:            F   D   C   B   A     __ NB! __ вариантов Оценок должно быть больше, чем Границ!
...
# ]
#
# print(f'Sorted ASCending by key "age": ', sort_dict(data, 'age'))
# print(f'Sorted ASCending by key "name": ', sort_dict(data, 'name'))


""" ______  Task 7  ______________________________________________________________________________________________ """
# 3. Напишите функцию, которая принимает список строк и возвращает словарь, где ключи — строки, а значения —
# длина этих строк. Добавьте документацию и аннотации типов для всех параметров и возвращаемого значения.

# def convert_str_to_dict(strings_list: list[str]) -> dict[str, int]:
#     return {_trings_list: len(_trings_list) for _trings_list in strings_list}
#
...
#
# gen = generate_unique_elements()                  # В ЭТОЙ СТРОКЕ СТАВИТЬ ДЕБАГ!!!!
# next(gen)                               # The SAME!!!           # next() - ВСЕГДА отдаёт.
# # gen.__next__()                        # The SAME!!!
# print(next(gen))
# for i in range(3):
